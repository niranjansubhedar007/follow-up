...
import {faTasks, faSquareCheck, faHourglassStart, faExclamationCircle, faPenToSquare, faTableCellsLarge, faUser, faLinesLeaning, faBarsStaggered, faSquarePlus, faUpload, faDownload, faAngleUp } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-start">
                            ...
                            <Link href="#" className="flex ml-2 md:mr-24">
                                ...
                                <span className="self-center text-base md:text-xl font-semibold whitespace-nowrap dark:text-white md:pl-5 text-white">Employee</span>
                            </Link>
                        ...
                        <div className="flex items-center">
                            ...
                            >
                                <FontAwesomeIcon icon={faEnvelope} className="text-lg md:text-xl fa-lg justify-between text-white pr-1" />
                            ...
                            >
                                <FontAwesomeIcon icon={faBell} className="text-lg md:text-xl fa-lg justify-between text-white pr-3" />
                                {notificationCount > 0 && (
